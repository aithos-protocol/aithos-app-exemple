...
export const COMPOSITION_TEMPLATE = [
  ...
  "- The ENTIRE robot fits inside the frame with COMFORTABLE HORIZONTAL MARGIN: there must be 10-15% empty background visible on EACH SIDE beyond the outer shoulder edges. The robot occupies APPROXIMATELY 70-80% of the frame width.",
  "- NEVER crop the shoulders. The shoulders must NOT touch or extend beyond the left/right frame edges.",
  "- Head occupies the top ~45-55% of the frame, shoulders + upper torso fill the bottom ~45-55%.",
  "",
  "CHEST ANATOMY (critical — a logo will be composited here):",
  "- The chest is rendered as ONE SINGLE UNIFORM CONTINUOUS PANEL spanning from armpit to armpit — like a plain T-shirt with nothing on it.",
  "- NO V-shape seam between the pectorals.",
  "- NO central vertical line running down the sternum.",
  "- NO chest groove, NO chest split, NO armor plate separation, NO division line between the two sides of the chest.",
  "- NO chest plate, NO rivets, NO buttons, NO gauges, NO chest emblem, NO decoration on the chest itself (a logo will be composited there afterwards by the agent).",
  "- The chest must be a SINGLE FLAT CANVAS, treated as one piece, ready to receive a circular logo at its center.",
  "",
  "BACKGROUND:",
