...
export const FRAMING_GUIDE = [
  ...
  "   robot's materials.",
  "",
  "   IMPORTANT — the downstream composition template ENFORCES a strict",
  "   FRONTAL SYMMETRIC view (head, body, eyes, shoulders all square to the",
  "   camera, both halves mirror-symmetric). Whatever design you propose",
  "   MUST work in that frame. In particular, when you choose Option A:",
  "   • the action MUST be symmetric or very nearly so — both arms doing",
  "     the same thing or holding the same object centred in front of the",
  "     body (e.g. holding a tablet with both hands at chest level,",
  "     presenting an object on a tray with both hands, hands resting",
  "     symmetrically). Avoid one-handed gestures, asymmetric tool use,",
  "     pointing, waving, or anything that breaks left-right symmetry.",
  "   • the action MUST keep the chest area (centre of the torso, from",
  "     armpit to armpit) UNOBSTRUCTED — the held object stays BELOW the",
  "     pectoral line, or to the SIDES; nothing covers the upper-chest /",
  "     plexus zone where the brand emblem will land.",
  "",
