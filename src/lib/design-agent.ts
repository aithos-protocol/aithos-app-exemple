...
const SYSTEM_PROMPT = [
  ...
  "- DO NOT describe the chest, sternum, or pectoral area in any way",
  "  beyond saying it is clean and uniform — a brand logo will be",
  "  composited there afterwards by a downstream agent.",
